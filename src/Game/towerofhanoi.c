...
void towerArt()
{
    printf("                                                              ,d8888b     d8b                                    d8,\n");
    printf("   d8P                                                        88P'        ?88                                   `8P \n");
    printf("d888888P                                                   d888888P        88b                                      \n");
    printf("  ?88'   d8888b  ?88   d8P  d8P d8888b  88bd88b     d8888b   ?88'          888888b  d888b8b    88bd88b  d8888b   88b\n");
    printf("  88P   d8P' ?88 d88  d8P' d8P'd8b_,dP  88P'  `    d8P' ?88  88P           88P `?8bd8P' ?88    88P' ?8bd8P' ?88  88P\n");
    printf("  88b   88b  d88 ?8b ,88b ,88' 88b     d88         88b  d88 d88           d88   88P88b  ,88b  d88   88P88b  d88 d88 \n");
    printf("  `?8b  `?8888P' `?888P'888P'  `?888P'd88'         `?8888P'd88'          d88'   88b`?88P'`88bd88'   88b`?8888P'd88' \n");
}
