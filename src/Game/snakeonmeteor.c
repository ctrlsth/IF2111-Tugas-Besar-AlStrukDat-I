...
void snakeart()
{
    printf(" _______  _        _______  _        _______    _        _______ ");
    printf("       ---_ ......._-_--. \n");
    printf("(  ____ \\| \\    /\\(  ___  )( (    /|(  ____ \\  ( (    /|(  ___  )");
    printf("      (|\\ /      / /| \\  \\   \n");
    printf("| (    \\/|  \\  / /| (   ) ||  \\  ( || (    \\/  |  \\  ( || (   ) |");
    printf("      /  /     .'  -=-'   `. \n");
    printf("| (__    |  (_/ / | (___) ||   \\ | || (_____   |   \\ | || |   | |");
    printf("     /  /    .'             )\n");
    printf("|  __)   |   _ (  |  ___  || (\\ \\) |(_____  )  | (\\ \\) || |   | |");
    printf("   _/  /   .'        _.)   / \n");
    printf("| (      |  ( \\ \\ | (   ) || | \\   |      ) |  | | \\   || |   | |");
    ...
    printf("  \\          _.-'    / .'*|  \n");
    printf("(_______/|_/    \\/|/     \\||/    )_)\\_______)  |/    )_)(_______)");
    printf("   \\______.-'//    .'.' \\*|  \n");
    printf("      _______  _______ _________ _______  _______  _______       ");
    printf("    \\|  \\ | //   .'.' _ |*|  \n");
    printf("     (       )(  ____ \\\\__   __/(  ____ \\(  ___  )(  ____ )      ");
    printf("     `   \\|//  .'.'_ _ _|*|  \n");
    printf("     | () () || (    \\/   ) (   | (    \\/| (   ) || (    )|      ");
    printf("      .  .// .'.' | _ _ \\*|  \n");
    printf("     | || || || (__       | |   | (__    | |   | || (____)|      ");
    ...
    printf("     '  `             \\ _ _ \\  \n");
    printf("     |/     \\|(_______/   )_(   (_______/(_______)|/   \\__/      ");
    printf("                       \\_      \n");
    // delay(2000);
    printf("\n\n\n");
